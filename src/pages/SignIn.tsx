          ...
          <Card className="backdrop-blur-md bg-card/80 border-primary/20 shadow-2xl shadow-primary/20 cultural-card hover:shadow-primary/30 transition-all duration-500">
            ...
            <CardContent className="relative">
              ...
              <div className="relative z-10">
                ...
                {/* X (Twitter) Sign In */}
                <Button type="button" variant="outline" onClick={() => signInWithTwitter()} disabled={isSubmitting} className="w-full h-12 bg-black text-white border-2 border-black hover:bg-gray-900 font-semibold transition-all duration-300 flex items-center justify-center gap-3 mx-0 my-[10px] px-0 py-0">
