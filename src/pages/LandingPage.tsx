        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mt-8 sm:mt-12">
            ...
            <div className="bg-card p-4 sm:p-6 rounded-lg border border-border space-y-2 sm:space-y-3">
              ...
              <h3 className="text-lg sm:text-xl font-afro-heading text-foreground font-medium">Virtual Dates & Shared Events </h3>
              <p className="text-sm sm:text-base text-muted-foreground">Explore new ways to connect, like cooking a dish together over video calls,  attend cultural events, film/music festivals, poetry slams. Meet your match while immersing yourself in art, culture, and history.
            ...
            <div className="bg-card p-4 sm:p-6 rounded-lg border border-border space-y-2 sm:space-y-3">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">Enjoy curated playlists designed around different cultural genres.</p>
            </div>
            <div className="bg-card p-4 sm:p-6 rounded-lg border border-border space-y-2 sm:space-y-3">
              ...
              <p className="text-sm sm:text-base text-muted-foreground">Engage in meaningful conversations, whether it's about philosophy, literature, or film or music. Our platform's focus is on building deeper emotional and intellectual connections.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 mt-8 sm:mt-12">
            ...
            <div className="text-center space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-afro-heading text-foreground px-2 font-medium">Personalized Matchmaking</h3>
            ...
            <div className="text-center space-y-3 sm:space-y-4">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl font-afro-heading text-foreground px-2 font-medium">Share and Connect</h3>
      ...
      <section id="collective" className="py-12 sm:py-16 lg:py-24 px-3 sm:px-6 lg:px-8 bg-secondary/10">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="bg-card p-5 sm:p-6 lg:p-8 rounded-lg border border-border text-center space-y-2 sm:space-y-3 hover:border-primary transition-colors">
              <h3 className="text-lg sm:text-xl font-afro-heading text-foreground font-medium">Embark on a Digital Cultural Journey</h3>
