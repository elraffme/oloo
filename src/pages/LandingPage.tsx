...
const LandingPage = () => {
  ...
  return <div className="min-h-screen flex flex-col overflow-hidden bg-black">
      ...
      <div className="relative min-h-[70vh] sm:min-h-[80vh] lg:min-h-screen flex flex-col">
        ...
        <div ref={videoRef} className={`w-full h-full transition-all duration-1000 ${isVideoPlaying ? 'scale-105' : 'scale-100'} bg-cover bg-no-repeat bg-[35%_25%] sm:bg-[40%_30%] md:bg-center`} style={{
