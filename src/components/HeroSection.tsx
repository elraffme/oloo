    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          Experience luxury dating with exclusive streaming features, premium matchmaking, 
          and sophisticated connections that matter.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-primary to-accent text-primary-foreground border-0 hover:scale-105 transition-all duration-300 px-8 py-6 text-lg font-semibold shadow-lg hover:shadow-xl"
          >
